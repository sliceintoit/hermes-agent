# AGENTS Expanded Reference

This file holds the detailed architecture, subsystem, workflow, skill, and testing reference
material extracted from the root `AGENTS.md` to keep the always-loaded prompt smaller.
Load it when a task touches any of the sections below.
